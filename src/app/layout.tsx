...
export const metadata: Metadata = {
  ...
  description:
    "강남 달토 런닝래빗 - 강남역 도보 5분, 11년 전통 프리미엄 가라오케. 정찰제 가격, 초이스 시스템, VIP 서비스. 신대표 24시간 직접 응대 ☎ 010-2303-3778",
  ...
  openGraph: {
    title: "강남 달토 가격·후기·시스템 총정리",
    description:
      "11년 전통 프리미엄 가라오케. 정찰제 가격, 초이스 시스템, VIP 서비스. 강남역 도보 5분. 신대표 24시간 직접 응대 ☎ 010-2303-3778",
    type: "website",
  ...
  twitter: {
    ...
    title: "강남 달토 가격·후기·시스템 총정리",
    description:
      "강남역 도보 5분, 11년 전통 프리미엄 가라오케. 정찰제, 초이스 시스템. ☎ 010-2303-3778",
