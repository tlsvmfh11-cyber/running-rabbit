export default function JsonLd() {
  ...
  const faqPage = {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "강남 달토 주차나 발렛 서비스가 있나요?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "네, 발렛 주차 서비스를 제공합니다. 강남역 10번 출구에서 도보 5분 거리라 대중교통도 편리하며, VIP 고객께는 픽업 서비스도 제공합니다. 필요 시 예약할 때 미리 말씀해주세요."
        }
      },
      {
        "@type": "Question",
        "name": "강남 달토 단체 회식은 몇 명까지 가능한가요?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "2인 소규모부터 20인 이상 대규모 단체까지 가능합니다. 인원에 따라 룸을 연결해 사용할 수 있으며, 법인카드 결제와 세금계산서 발행도 가능합니다. 단체 방문은 미리 예약을 권장합니다."
        }
      }
    ]
  }
